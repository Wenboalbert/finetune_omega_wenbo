...
## V001 register-token scaffold (2026-09-10)

Start with [README_V001.md](README_V001.md). This is infrastructure only; no adaptation is implemented.
Inherited code and benchmark text below are reference only. Legacy PBS entrypoints remain disabled here.
